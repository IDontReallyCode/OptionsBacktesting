...
def main():
    ...
    ordershortput = obt.Order(0, 0, 'KSS', obt.ASSET_TYPE_OPTION, symbol='kssoptiontest', action=obt.SELL_TO_OPEN, quantity=1,
    ...
    ordershortcall = obt.Order(0, 0, 'KSS', obt.ASSET_TYPE_OPTION, symbol='kssoptiontest', action=obt.SELL_TO_OPEN, quantity=1,
    tickerprice=32.68, optionprice=2.93, ordertype=obt.ORDER_TYPE_MARKET, pcflag=1, k=32.5, expirationdate='2022-09-16')
    ...
    ordershortstock = obt.Order(0, 0, 'KSS', obt.ASSET_TYPE_STOCK, symbol='kssoptiontest', action=obt.SELL_TO_OPEN, quantity=1,
